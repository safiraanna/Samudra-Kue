...
Route::put('/update_checklist', [CartController::class, 'updateChecklist'])->name('update_checklist');
...
Route::get('/sales-report', [AdminController::class,'weeklySalesReport'])->name('weekly.sales.report');
Route::get('/sales-report/{year}/{month}/{week}', [AdminController::class, 'weeklySalesDetails'])->name('weekly.sales.details');
